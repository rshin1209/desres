...
The dataset released by D. E. Shaw Research contains six 500-μs simulations of SARS-CoV-2 NiRAN domain targeted peptides. D. E. Shaw Research.
...
**Figure 2** highlights notable entropy changes in M1Y, I7K, and R20K (A#B denotes mutation from A to B at residue number #). Beyond the mutation sites, phenylalanine (F at residue 15) undergoes a substantial alteration in correlations with other residues. This pattern is further evident in **Figure 3**, comparing peptides A and C, where mutation sites include K2Y, R19L, and R20K. Conversely, the comparison between peptides B and C in **Figure 4** reveals anticipated entropy changes solely at the mutation sites Y1M, K2Y, K7I, and R19L.
...
These findings suggest a potential influence of lysine (residue 20), present in peptides B and C but not in peptide A, on affecting the correlation between phenylalanine and the NiRAN domain (**Figure 5**). This observation aligns with the results of viral infection experiments (**Table 2**), where peptide A exhibited the highest average inhibition at 100 µM. It is conceivable that the mutation of residue 20 from arginine to lysine has led to a loss of correlation between phenylalanine and the NiRAN domain for inhibition, resulting instead in an increased correlation within peptides B and C. Hence, it can be suggested that the lower correlation of phenylalanine with other residues in the peptide may result in higher average inhibition of Vero Cells by SARS-CoV-2 through a stronger correlation with the NiRAN domain.
...
In addition to a notable entropy change in I7K, **Figure 6** highlights a significant reduction in the correlation change for phenylalanine (residue 15) from peptide A-dis to B-dis. Moving to **Figure 7**, while there is also a decrease in the correlation change for phenylalanine from peptide A-dis to C-dis, this change is less pronounced than the previous one. Finally, **Figure 8** reveals a substantial increase in the correlation change for phenylalanine (residue 15) from peptide B-dis to C-dis. These findings align with our earlier hypothesis that phenylalanine in peptide B exhibits the lowest correlation with other residues within the peptide, potentially contributing to the highest average inhibition at 100 µM among peptides A-dis, B-dis, and C-dis.

Both **Figure 7** and **Figure 8** demonstrate significant alterations in residue entropy and correlation for R19L. According to the comparisons, peptide C-dis exhibits the least correlation between leucine (residue 19) and other residues. In **Figure 7**, peptide A-dis shows the highest correlation difference of 7.7 kcal/mol in residue 19 (Arginine). Meanwhile, in **Figure 8**, peptide B-dis displays the greatest correlation difference of 6.1 kcal/mol in residue 19 (Arginine). These substantial variations in correlations at residue 19 suggest a potential inference that leucine plays a significant role in tolerance among peptides A-dis, B-dis, and C-dis, potentially contributing to the highest average viability of peptide C-dis.

In summary, these results imply that designing a peptide with reduced correlation of phenylalanine (residue 15) in the presence of leucine (residue 19) may lead to both high average inhibition and average viability.
